...
- Estado real y trampas conocidas: `docs/HANDOFF.md` (léelo entero antes de tocar nada; §0.0 y
  §0.0.1 son la v9.1, la que está en producción; §0–§0.2, la v8.2 anterior).
- **v9.1 en `main` y publicada** (20-09-2026): tres lugares —Consciencia `01`, Genoma `10`,
  ...
  si hay que aligerar, se encogen los botones, no se quitan. Rendimiento: calidad adaptativa
  (`src/lib/quality.ts`), el fondo cede ante la Consciencia, luz del puntero por compositor.

...
| **Cuerpo**: biolectura (rótulo `EVA-01`, estados, botones, respuestas, nombres de los puntos de lectura, nombre y antetítulo de cada toma) | `content/ejes.ts` | `ejes.cuerpo.exterior` |
